...
baseInstanceDatamaster.interceptors.request.use(
  (config) => {
    const token =
      "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..bE1Z9RZe2KxIXojaqpi1BpUuNgbE9MtvfXKp_x8FtmHuHHeWVmakQdtxzh5Rsx_7Fxfy1tYIQ6vfT8izy4PYBV0O1MSp6O2ZCw25j_Rz0nvqFzR1loxyY8TiSAPRSurlvuh3xS4wcC8W8RuI6HaEANGpnrRDVKdIlVBsekvzEHNRonbAGWJEvDKz9BlQiS11VReXwqeneXSjqK02shblPIarBtpGlEGJuaGIXqXEVEN1KN4KkB0sPrf5cY0TtZ9Lrpo9Dye9gPpWEDP-bf-9Sv0DTOilAUUSWTjny6bcB9jgdTRMrMyEVXwt6F6OkZFU76O21HKEiChzdFEeUzCyHA";
    if (!token) {
      config.headers["Authorization"] = "";
    } else {
      config.headers["Authorization"] = `Bearer ${token}`;
