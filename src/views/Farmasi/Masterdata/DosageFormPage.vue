...
const dataSediaan = ref([
  { kodeSediaan: "CAP", namaSediaan: "Capsule", status:"AKTIF" },
  { kodeSediaan: "TAB", namaSediaan: "Tablet", status:"AKTIF" },
  { kodeSediaan: "INF", namaSediaan: "Tablet", status:"AKTIF" },
]);
</script>
...
<template>
  <div class="flex flex-col h-full overflow-hidden">
    ...
    >
      ...
      <template #content>
        ...
        >
          ...
          <Column field="kodeSediaan" header="Kode Sediaan" headerClass="bg-adameds-50 font-semibold text-SM"></Column>
          <Column field="namaSediaan" header="Nama Bentuk Sediaan" headerClass="bg-adameds-50 font-semibold text-SM"></Column>
      ...
      <template #footer>
        <div class="flex justify-between px-5 py-2.5">
          ...
          <CustomPaginator
            :rows="rowsPerPage"
            :totalRecords="dataSediaan.length"
    ...
    <!-- sediaanDialog -->
    <CustomDialog v-model:visible="sediaanDialog" width="600px">
      <template #header>
