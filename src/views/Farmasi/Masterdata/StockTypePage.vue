...
const jenisStokDialog = ref(false);
...
const dataJenisStok = ref([
  { nama: "Box", status:"AKTIF" },
  { nama: "Pcs", status:"AKTIF" },
  { nama: "Tablet", status:"AKTIF" },
  { nama: "Kapsul", status:"AKTIF" },
  { nama: "Box", status:"NON-AKTIF" },
]);
</script>
...
<template>
  <div class="flex flex-col h-full overflow-hidden">
    ...
    >
      ...
      <template #content>
        ...
        >
          ...
          <Column field="nama" header="Nama Jenis Stok" headerClass="bg-adameds-50 font-semibold text-SM"></Column>
      ...
      <template #footer>
        <div class="flex justify-between px-5 py-2.5">
          ...
          <CustomPaginator
            :rows="rowsPerPage"
            :totalRecords="dataJenisStok.length"
    ...
    <!-- jenisStokDialog -->
    <CustomDialog v-model:visible="jenisStokDialog" width="400px">
      <template #header>
        <div class="grid grid-cols-1">
          <p>Tambah Jenis Stok</p>
        </div>
      </template>
      <template #body>
        <div class="grid grid-cols-1">
          <div class="mt-[20px]">
            <CustomTextfield
              label="Nama Jenis Stok"
              placeholder="Nama Jenis Stok"
              class=""
            />
          </div>
        </div>
