...
// Reset search input and re-fetch data
const resetSearch = () => {
  searchQuery.value = "";
  DrugCategoryProperties.value.page = 1;
  fetchKategoriObat();
};
...
const ExportExcel = async () => {
  try {
    ...
    const { page, page_size } = DrugCategoryProperties.value;
        ...
        >
          <Column headerClass="bg-adameds-50 font-semibold text-SM">
            ...
            <template #body="slotProps">
              <div class="">
                {{
                  (DrugCategoryProperties.page - 1) *
                    DrugCategoryProperties.page_size +
                  slotProps.index +
                  1
                }}
              </div>
          ...
          <Column
            field="code"
            header="Kode Kategori Obat"
            headerClass="bg-adameds-50 font-semibold text-SM"
          ></Column>
          <Column
            field="name"
            header="Nama Kategori Obat"
            headerClass="bg-adameds-50 font-semibold text-SM"
          ></Column>
