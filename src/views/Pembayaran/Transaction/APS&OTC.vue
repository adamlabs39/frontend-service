                ...
                <CustomAccordion :openWithHeader="false" noBorder>
                    ...
                    <template #content>
                        ...
                        <div class="flex mb-[10px] mt-5 font-semibold text-SM text-grey-300">
                            ...
                            <div class="flex">
                                |
                                <CustomChip v-for="(poli, index) in filterPoliList" :key="poli + index" :label="poli"
                                    class="ml-[10px]" :isSelected="selectedFilterPoli.includes(poli)"
                        ...
                        <div class="flex my-[10px] mt-5 font-semibold text-SM text-grey-300">
                            ...
                            <div class="flex">
                                |
                                <CustomChip label="TUNAI" borderColor="border-adameds-300" bgColor="bg-adameds-50"
                                    iconColor="text-adameds-300" textColor="text-adameds-300" customClass="h-5"
                                    class="ml-[10px]" :isSelected="selectedPaymentMethod.includes('TUNAI')"
                                    @selected="onPaymentMethodSelect"
                                    selectedColor="bg-adameds-300 border-adameds-300" />
                                <CustomChip label="ASURANSI" borderColor="border-warning-300" bgColor="bg-warning-50"
                                    iconColor="text-warning-300" textColor="text-warning-300" customClass="h-5"
                                    class="ml-[10px]" :isSelected="selectedPaymentMethod.includes('ASURANSI')"
                                    @selected="onPaymentMethodSelect"
