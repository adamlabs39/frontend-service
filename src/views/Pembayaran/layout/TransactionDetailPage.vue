    ...
    <Card pt:body:class="h-full pt-0 overflow-auto" pt:content:class="h-full overflow-hidden"
      ...
      <template #content>
        <div class="grid grid-flow-col grid-rows-2 gap-2">
          ...
          <div class="mt-[-400px]">
            <DataTable :value="itemsPasien" scrollable scrollHeight="390px" class="overflow-hidden rounded-[10px]"
              :pt="{ headerRow: 'text-SM' }" @rowClick="listTagihanRIDialog = true">
    ...
    <CustomDialog v-model:visible="listTagihanRIDialog" width="1000px">
      ...
      <template #body>
        <div>
          ...
          <!-- Table Kamar -->
          <div class="pt-5">
            <DataTable v-if="itemsPasien.length" :value="itemsPasien" class="overflow-hidden rounded-[10px]" scrollable
              scrollHeight="flex" :pt="{ headerRow: 'text-SM' }">
              <!-- Tanggal -->
