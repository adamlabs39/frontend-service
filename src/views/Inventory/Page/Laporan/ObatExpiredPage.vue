...
const updatePageType = (path: string) => {
  ...
  dataBreadCrumb.value = [
    {
      label: pageType.value == "obat-expired" ? "Obat Expired" : "",
    },
  ];
...
const totalRecords = ref(obatExpiredData.value.length);
</script>
...
<template>
  ...
  >
    ...
    <template #content>
      <DataTable
        v-if="obatExpiredData.length"
        :value="obatExpiredData"
      ...
      >
        ...
        <Column
          ...
          header="Tgl. Expired"
          header-class="text-center text-black bg-adameds-50"
          class="w-[100px] text-center text-black text-SM"
        />
