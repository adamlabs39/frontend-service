...
<template>
  <div class="flex flex-col gap-5 overflow-auto grow">
        ...
        <div class="flex flex-col gap-5 py-5">
          <div class="flex flex-col gap-2.5">
            ...
            <div class="flex w-full border rounded-lg p-2.5 gap-2.5">
              <CustomSwitch v-model="toggleSwitch" :show-label="false" />
    ...
    <div>
      ...
      <div class="w-full border rounded-lg p-2.5">
        <div class="flex items-center gap-2.5">
          <CustomSwitch v-model="status" :disabled="!selectedRole" :show-label="false" />
