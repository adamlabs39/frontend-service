...
<template>
  <!-- {{ payload }} -->
  <DataTable :value="payload" tableStyle="min-width: 50rem" stripedRows class="-m-4 text-xs" scrollable
    scrollHeight="flex">
    ...
    <Column field="code" header="Kode Tarif" headerClass="bg-adameds-50"></Column>
    <Column field="name" header="Nama Tarif" headerClass="bg-adameds-50"></Column>
    <Column field="mode" header="Pilihan Tarif" headerClass="bg-adameds-50"></Column>
      ...
      <template #body="slotProps">
        <div class="flex flex-wrap gap-2">
          <div v-for="items in slotProps.data.pelayanan" :key="items">
            <CustomChip :label="items.unitPelayananName" :showCheckedIcon="false" border-color="border-none"
    ...
    <Column field="penjamin" header="Metode Pembayaran" headerClass="bg-adameds-50">
      <template #body="slotProps">
        <div class="flex flex-wrap gap-2">
