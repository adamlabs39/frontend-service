...
<template>
  <DataTable :value="products" tableStyle="min-width: 50rem" stripedRows class="-m-4 text-xs" scrollable
    scrollHeight="flex">
    ...
    <Column field="kode" header="Kode Tarif" headerClass="bg-adameds-50"></Column>
    <Column field="nama_tarif" header="Nama Tarif" headerClass="bg-adameds-50"></Column>
    <Column field="pilihan_tarif" header="Pilihan Tarif" headerClass="bg-adameds-50"></Column>
    ...
    <Column field="metode_pembayaran" header="Metode Pembayaran" headerClass="bg-adameds-50">
      <template #body="slotProps">
        <div class="flex flex-wrap gap-2">
    ...
    <Column field="tarif_harga" header="Tarif Harga" headerClass="bg-adameds-50" class="w-[100px]"></Column>
    ...
    <Column headerClass="bg-adameds-50">
      ...
      <template #body="slotProps">
        <div class="flex items-center gap-2.5 justify-center">
          ...
          <CustomButton label="" background-color="bg-danger-300 rounded-lg" @click="hapusDataDialog = true"
  ...
  <CustomDialog width="600px" v-model:visible="hapusDataDialog" headerBg="bg-danger-300">
    <template #header>Hapus Tarif</template>
    <template #body>
      <div class="flex flex-col gap-5 mt-5">
        <CustomTextfield label="Alasan Hapus Tarif" placeholder="Alasan Hapus Tarif" />
        <div class="italic text-normal text-danger-300">*Setelah hapus, data akan <span
            class="font-bold">terupdate</span> dan akan <span class="font-bold">mempengaruhi seluruh pelayanan</span>
        </div>
      </div>
    </template>
    <template #footer>
      <div class="w-full">
        ...
        <div class="mt-5 flex justify-end gap-2.5">
          <CustomButton label="Batal" border-color="border-grey-200" background-color="bg-white"
            text-color="text-grey-300" @click="hapusDataDialog = false">
          </CustomButton>
