...
const downloadExportExcel = async () => {
  try {
    const response = await loincStore.exportApi();
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Datamaster LOINC");
    XLSX.writeFile(workbook, `Datamaster LOINC.xlsx`);
  } catch (error) {
