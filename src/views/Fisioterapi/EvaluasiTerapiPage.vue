...
const filteredData = computed(() => {
  ...
  if (selectedPayType.value === "MenungguPembayaran") {
    data = data.filter((item) => item.statusPelayanan !== "SELESAI"); // Belum Terjadwal
  } else if (selectedPayType.value === "Lunas") {
    data = data.filter((item) => item.statusPelayanan === "SELESAI"); // Terjadwal
  }
...
<template>
  <div class="flex flex-col w-full h-full overflow-hidden">
            ...
            <template #body="slotProps">
              <div>
                <CustomChip
                  ...
                  :bgColor="
                    slotProps.data.statusPelayanan == 'EVALUASI'
                      ? 'text-blueJeans-300'
                      : slotProps.data.statusPelayanan == 'TERAPI'
                      ? 'bg-grey-75'
                      : 'bg-adameds-50'
                  "
                  :textColor="
    ...
    <CustomDialog v-model:visible="popupDialog" width="700px">
      <template #header>
        <div class="flex text-heading">Proses Terapi</div>
      </template>
      <template #body>
        <div>
          <div class="pt-5 mb-20">
            <p>
              Apakah Anda ingin
              <span class="font-bold">memproses Evaluasi</span> pasien ini?
            </p>
