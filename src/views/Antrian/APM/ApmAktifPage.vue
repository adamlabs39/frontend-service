...
<template>
  ...
  >
    <template #body>
      <div
        class="flex justify-between gap-5 pr-5 mt-[10px] bg-adameds-300 rounded-xl max-md:flex-wrap shadow-md py-0"
      >
        <div
        ...
        >
          ...
          >
            ...
            />
            <div
              class="bg-adameds-300 w-[2px] h-[50px] my-auto rounded-md"
            ></div>
            <img
              loading="lazy"
          ...
          <div class="flex flex-col mx-1 my-auto">
            ...
            <div class="mb-1 font-bold text-m">
        ...
        <div class="overflow-hidden rounded-xl">
          <div class="flex transition-transform duration-300">
            ...
            <img
              ...
              class="w-2/5 h-[280px] object-cover"
            />
          </div>
        </div>
      </div>
