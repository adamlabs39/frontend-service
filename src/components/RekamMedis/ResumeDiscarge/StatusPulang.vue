    ...
    <template #content>
      <div class="flex flex-col gap-5 pt-5">
        ...
        <div  v-if="selectedStatus === 'Dirujuk'" class="flex flex-col gap-5">
            <div  class="flex gap-[30px]">
          <div class="grid grid-cols-2  gap-x-5  pr-[30px] border-r border-grey-200">
          ...
          <CustomSelect label="Rujukan Internal" place-holder="Pilih Rujukan Internal" class="grow"/>
          <CustomTextfield label="Keterangan Rujukan Internal" placeholder="Keterangan Rujukan Internal" class="grow"/>
        </div>
        <div class="flex gap-[30px]"> 
            <CustomSelect label="Instruksi Kontrol Ke" place-holder="Pilih Instruksi Kontrol Ke" class="grow"/>
            <CustomTextfield label="Instruksi Kontrol Ke Lainnya" placeholder="Instruksi Kontrol Ke Lainnya" class="grow"/>
            <CustomDatePicker label="Tanggal Instruksi"/>
        </div>
        <div class="flex gap-[30px]">
            <CustomTextfield label="No. Darurat" class="grow"/>
            <CustomSelect label="Transportasi" place-holder="Pilih Transportasi" class="grow"/>
            <CustomTextfield label="Transportasi Lainnya" placeholder="Transportasi Lainnya" class="grow"/>
