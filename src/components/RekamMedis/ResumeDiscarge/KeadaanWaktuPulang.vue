        ...
        <template #content>
            <div class="grid grid-cols-12 gap-5 pt-5">
                <div class="flex flex-col col-span-3">
                    ...
                    <div class="font-normal text-normal">{{ tandaVital.tekananDarah }} mmHg</div>
                </div>
                <div class="flex flex-col col-span-3">
                    <div class="font-semibold underline text-SM">Frekuensi Nafas</div>
                    <div class="font-normal text-normal">{{ tandaVital.frekuensiNafas }} x/mnt</div>
                </div>
                <div class="flex flex-col col-span-3">
                    <div class="font-semibold underline text-SM">Frekuensi Nadi</div>
                    <div class="font-normal text-normal">{{ tandaVital.frekuensiNadi }} x/mnt</div>
                </div>
                <div class="flex flex-col col-span-3">
                    <div class="font-semibold text-SM">Suhu</div>
                    <div class="font-normal text-normal">{{tandaVital.suhu}} °C</div>
                </div>
                <CustomSelect v-model="kondisiPasienPulang" :options="optionsKondisiPasien" option-label="label" option-value="value" class="col-span-12" label="Kondisi Pasien Saat Pulang" place-holder="Pilih Kondisi Pasien Saat Pulang" />
            </div>
